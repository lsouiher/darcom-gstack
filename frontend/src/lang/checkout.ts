...
const strings = new LocalizedStrings({
  ...
  ar: {
    ...
    AGENCY: 'الوكالة',
    COST: 'الإجمالي',
    RENTER_DETAILS: 'معلومات العميل',
    EMAIL_INFO: 'ستتلقى رسالة تأكيد على هذا العنوان.',
    PHONE_INFO: 'في حالة الحاجة للتواصل معك بشكل عاجل.',
    PAYMENT: 'الدفع الآمن',
    ...
    PAY_LATER_SUCCESS: 'تم الحجز بنجاح. لقد أرسلنا لك بريدًا إلكترونيًا للتأكيد.',
    PAYMENT_OPTIONS: 'خيارات الدفع',
    PAY_LATER: 'الدفع لاحقًا',
    PAY_LATER_INFO: 'تعديل وإلغاء مجاني',
    PAY_ONLINE: 'الدفع عبر الإنترنت',
    PAY_ONLINE_INFO: 'التعديل والإلغاء وفق الشروط',

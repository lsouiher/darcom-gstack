...
If you have any questions about this Cookie Policy, please contact us at: ${env.CONTACT_EMAIL}
  ...
  ar: {
    ...
    POLICY: `
توضح سياسة ملفات تعريف الارتباط هذه كيف يستخدم ${env.WEBSITE_NAME} ("نحن" أو "لنا") ملفات تعريف الارتباط والتقنيات المماثلة على موقعنا الإلكتروني. باستخدام موقعنا الإلكتروني، فإنك توافق على استخدام ملفات تعريف الارتباط كما هو موضح في هذه السياسة.

1. ما هي ملفات تعريف الارتباط؟

ملفات تعريف الارتباط هي ملفات نصية صغيرة يتم تخزينها على جهازك (كمبيوتر، جهاز لوحي، هاتف ذكي) عند زيارة موقع إلكتروني. تساعد في تحسين تجربة التصفح من خلال تذكر تفضيلاتك وتقديم معلومات أو خدمات ذات صلة.

2. أنواع ملفات تعريف الارتباط التي نستخدمها

نستخدم الأنواع التالية من ملفات تعريف الارتباط:

- ملفات تعريف الارتباط الضرورية: هذه الملفات ضرورية لعمل الموقع ولا يمكن إيقافها في أنظمتنا.
- ملفات تعريف الارتباط الخاصة بالأداء: تساعدنا هذه الملفات في فهم كيفية تفاعل الزوار مع موقعنا من خلال جمع المعلومات والإبلاغ عنها بشكل مجهول.
- ملفات تعريف الارتباط الوظيفية: تمكن هذه الملفات الموقع من توفير وظائف محسنة وتخصيص.
- ملفات تعريف الارتباط الإعلانية: تُستخدم هذه الملفات لتقديم إعلانات ذات صلة وتتبع أداء الإعلانات.

3. كيف نستخدم ملفات تعريف الارتباط

نستخدم ملفات تعريف الارتباط من أجل:

- تحسين وظائف الموقع وأدائه.
- تحليل استخدام الموقع لتحسين خدماتنا.
- تخصيص تجربتك وتذكر تفضيلاتك.
- تقديم إعلانات مستهدفة بناءً على اهتماماتك.

4. إدارة تفضيلات ملفات تعريف الارتباط

يمكنك إدارة تفضيلات ملفات تعريف الارتباط في أي وقت عن طريق تعديل إعدادات متصفحك. تسمح لك معظم المتصفحات بما يلي:

- حظر جميع ملفات تعريف الارتباط.
- حذف ملفات تعريف الارتباط الموجودة.
- تلقي إشعارات عند تعيين ملف تعريف ارتباط.

يرجى ملاحظة أن تعطيل ملفات تعريف الارتباط قد يؤثر على تجربتك في موقعنا.

5. ملفات تعريف الارتباط الخاصة بأطراف ثالثة

قد نسمح لمزودي خدمات من أطراف ثالثة بوضع ملفات تعريف الارتباط على موقعنا لتحليل حركة المرور أو تقديم خدمات إعلانية أو تمكين ميزات إضافية. تخضع هذه الملفات لسياسات الخصوصية الخاصة بالأطراف الثالثة.

6. التغييرات على سياسة ملفات تعريف الارتباط

قد نقوم بتحديث سياسة ملفات تعريف الارتباط هذه من وقت لآخر لتعكس التغييرات في التكنولوجيا أو التشريعات أو ممارساتنا. سيتم نشر السياسة المحدثة على هذه الصفحة مع تاريخ "آخر تحديث" منقح.

7. اتصل بنا

إذا كانت لديك أي أسئلة حول سياسة ملفات تعريف الارتباط هذه، يرجى التواصل معنا على: ${env.CONTACT_EMAIL}
    `,
  },
})

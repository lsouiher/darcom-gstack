...
By using our services, you acknowledge that you have read and understood this Privacy Policy and agree to its terms.
  ...
  ar: {
    ...
    PRIVACY_POLICY: `
خصوصيتك مهمة لنا في ${env.WEBSITE_NAME}. توضح سياسة الخصوصية هذه كيف نجمع معلوماتك ونستخدمها ونحميها عند استخدام موقعنا الإلكتروني وخدماتنا. بالوصول إلى خدماتنا، فإنك توافق على الممارسات الموضحة في هذه السياسة.

1. المعلومات التي نجمعها

نجمع المعلومات منك عند التسجيل في موقعنا أو تقديم طلب أو التفاعل مع خدماتنا. قد تشمل المعلومات التي نجمعها:
...
معلومات الدفع
تفضيلات الإيجار
يمكنك زيارة موقعنا بشكل مجهول، لكن بعض الوظائف قد تكون محدودة.
...
نطبق مجموعة متنوعة من تدابير الأمان للحفاظ على سلامة معلوماتك الشخصية. يتم نقل جميع المعلومات الحساسة عبر خوادم آمنة ولا يمكن الوصول إليها إلا من قبل الموظفين المخولين. نحن لا نخزن معلومات بطاقتك الائتمانية على خوادمنا.

4. مشاركة معلوماتك

نحن لا نبيع أو نتاجر أو ننقل معلوماتك الشخصية إلى أطراف خارجية، باستثناء الشركاء الموثوقين الذين يساعدوننا في تشغيل موقعنا أو إدارة أعمالنا أو خدمتك، طالما وافقت تلك الأطراف على الحفاظ على سرية هذه المعلومات.

5. خصوصية الأطفال

نحن نلتزم بقانون حماية خصوصية الأطفال على الإنترنت (COPPA). خدماتنا ليست موجهة للأطفال دون سن 13 عامًا، ولا نجمع عن علم معلومات شخصية من أطفال دون 13 عامًا.

6. التغييرات على سياسة الخصوصية

قد نقوم بتحديث سياسة الخصوصية هذه من وقت لآخر. سنخطرك بأي تغييرات من خلال نشر سياسة الخصوصية الجديدة على هذه الصفحة.

7. حقوقك

لديك الحق في طلب الوصول إلى المعلومات الشخصية التي نحتفظ بها عنك، وطلب تصحيح أي أخطاء، وطلب حذف معلوماتك الشخصية.

8. اتصل بنا

إذا كانت لديك أي أسئلة حول سياسة الخصوصية هذه أو ممارسات البيانات لدينا، يرجى التواصل معنا على ${env.CONTACT_EMAIL}.

9. الإقرار

باستخدام خدماتنا، فإنك تقر بأنك قد قرأت وفهمت سياسة الخصوصية هذه وتوافق على شروطها.
    `,
  },
})

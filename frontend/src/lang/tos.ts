...
By using our services, you acknowledge that you have read and understood these Terms of Service and agree to be bound by them.
  ...
  ar: {
    ...
    TOS: `
مرحبًا بكم في ${env.WEBSITE_NAME}! بالوصول إلى موقعنا الإلكتروني واستخدام خدماتنا، فإنك توافق على الالتزام بشروط الاستخدام التالية. إذا كنت لا توافق على هذه الشروط، يرجى عدم استخدام خدماتنا.
...
أنت توافق على استخدام خدماتنا فقط لأغراض قانونية وبطريقة لا تنتهك حقوق الآخرين أو تقيد أو تمنع أي شخص آخر من استخدام خدماتنا. يشمل ذلك الامتثال لجميع القوانين واللوائح المعمول بها.

3. الحجوزات والمدفوعات

عند إجراء حجز مع ${env.WEBSITE_NAME}، فإنك توافق على تقديم معلومات دقيقة وكاملة. يجب أن تتم جميع المدفوعات من خلال نظام الدفع الآمن الخاص بنا. بمجرد إتمام الدفع، ستتلقى تأكيدًا لحجزك.

4. سياسة الإلغاء

قد يحق لك الحصول على استرداد كامل للإلغاءات التي تتم قبل 24 ساعة من تاريخ الإيجار. قد تتكبد الإلغاءات التي تتم قبل أقل من 24 ساعة من تاريخ الإيجار رسوم إلغاء. يرجى الرجوع إلى سياسة الإلغاء الخاصة بنا للحصول على معلومات مفصلة.

5. شروط الإيجار

تخضع جميع الإيجارات لشروط الإيجار الخاصة بنا، والتي تشمل على سبيل المثال لا الحصر قيود العمر والتزامات التأمين. أنت مسؤول عن التأكد من استيفائك لجميع المتطلبات قبل إجراء الحجز.

6. حدود المسؤولية

لن يكون ${env.WEBSITE_NAME} مسؤولاً عن أي أضرار غير مباشرة أو عرضية أو تبعية ناتجة عن استخدامك لخدماتنا. لن تتجاوز مسؤوليتنا الإجمالية بأي حال المبلغ الذي دفعته مقابل الخدمات.

7. تعديل الشروط

نحتفظ بالحق في تعديل شروط الاستخدام هذه في أي وقت. ستصبح أي تغييرات سارية فور نشرها على موقعنا الإلكتروني. يعتبر استمرارك في استخدام خدماتنا بعد أي تغييرات موافقة منك على الشروط الجديدة.

8. القانون المعمول به

تخضع شروط الاستخدام هذه وتُفسر وفقًا للقوانين. يتم حل أي نزاعات ناتجة عن هذه الشروط أمام المحاكم.
...
باستخدام خدماتنا، فإنك تقر بأنك قد قرأت وفهمت شروط الاستخدام هذه وتوافق على الالتزام بها.
    `,
  },
})
